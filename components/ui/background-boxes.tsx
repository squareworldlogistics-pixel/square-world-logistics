...
export const BoxesCore = ({ className, ...rest }: { className?: string }) => {
  ...
  let colors = [
    "rgba(59,110,181,0.15)",   // swl-blue tint
    "rgba(59,110,181,0.10)",
    "rgba(139,26,43,0.10)",    // swl-crimson tint
    "rgba(59,110,181,0.12)",
    "rgba(139,26,43,0.08)",
    "rgba(59,110,181,0.18)",
    "rgba(74,127,198,0.12)",   // swl-blue-light tint
    "rgba(59,110,181,0.08)",
    "rgba(139,26,43,0.12)",
  ];
